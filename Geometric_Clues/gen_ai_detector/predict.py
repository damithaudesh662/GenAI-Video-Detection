...
# index=str(445)
# path=Path(r"C:\Users\Admin\OneDrive\Desktop\my acadamics\sem 7\research\Git\GenAIVideoDetection\Geometric_Clues\Depth-Anything-V2\gen_ai_detector\gen_ai_new\depthmaps\gen_ai_new")
# folder = path / index
# pred, prob = predict_video_folder('best_r3d18_depthmaps_full.pt', folder)
