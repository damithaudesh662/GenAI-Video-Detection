...
#     num=str(i)
#     pred, prob = predict_video_folder('best_r3d18_depthmaps_full.pt', f'dataset/depthmaps/real/{num}')
    
#     print(f"real_{i}",pred, prob)
    
# for i in range(1,925):
    
#     pred, prob = predict_video_folder('best_r3d18_depthmaps_full.pt', f'dataset/depthmaps/gen_ai/{str(i)}')
#     print(f"gen_ai_{i}",pred, prob)

pred, prob = predict_video_folder('best_r3d18_depthmaps_full.pt', 'output_depthmaps/input')
print(f"output_depthmaps/input",pred, prob)